                                       ...
                                       char *buf)
{
       ...
       // }
	   printk("custom_changelogo_show--%d--\n",chooselogo);
        return sprintf(buf, "%d\n", chooselogo);  
...
ssize_t custom_changelogo_store(struct kobject *kobj, struct kobj_attribute *attr,
                         const char *buf, size_t n)
{  
	printk("custom_changelogo_store--buf[0]=%d,buf[1]=%d--\n",buf[0],buf[1]);
    ...
    {   
       // set_env("changelogo", "2");
			chooselogo=2;
    }
    else if(!strncmp(buf,"3",1))  
    {   
      //  set_env("changelogo", "3");
	  chooselogo=3;
    }
    else if(!strncmp(buf,"4",1))  
    {   
       // set_env("changelogo", "4");
		chooselogo=4;
    }
    else if(!strncmp(buf,"5",1))  
    {   
       // set_env("changelogo", "5");
	   chooselogo=5;
    }
    else if(!strncmp(buf,"6",1))  
    {   
       // set_env("changelogo", "6");
	    chooselogo=6;
    }
    else if(!strncmp(buf,"7",1))  
    {   
       // set_env("changelogo", "7");
	    chooselogo=7;
    }*/
    return n;
}
